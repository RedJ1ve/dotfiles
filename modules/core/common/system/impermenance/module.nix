  ...
  config = mkIf cfg.enable {
    users = {
      ...
      users = {
        ...
        aecyr = {
          hashedPasswordFile = "/persist/passwords/aecyr";
        };
      };
    };
    ...
    boot.initrd.systemd.services.rollback = {
      ...
      script = ''
        ...
        mount -o subvol=/ /dev/mapper/vg-NIXOS /mnt

        # If home is meant to be impermanent, also mount the home subvolume to be deleted later
        ${optionalString cfg.home.enable "mount -o subvol=/home /dev/mapper/vg-NIXOS /mnt/home"}
        ...
        ${optionalString cfg.home.enable ''
          ...
          mount -o subvol=/home /dev/mapper/vg-NIXOS /mnt/home
        ''}
